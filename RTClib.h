...
//  added DS3231 functions: setBBSQW getBBSQW setINTCN getINTCN setA1F 
 ...
 */	
    ...
    void setBBSQW(bool TF); // ADDED BY VKING (is OFF on first powerup)
    // set BBSQW pin to on to enable batterybacked SQW-INT function // added by Vking !!

    bool getBBSQW(); // ADDED BY VKING (is OFF on first powerup)
    // get BBSQW pin status for batterybacked SQW-INT function // added by Vking !!
    
    void setINTCN(bool TF); // ADDED BY VKING (is ON on first powerup)
    // set INTCN pin to on to enable batterybacked INT function // added by Vking !!

    bool getINTCN(); // ADDED BY VKING (is ON on first powerup)
    // get INTCN pin status for batterybacked SQW-INT function // added by Vking !!
    
    void setA1F(bool TF); // ADDED BY VKING
    // Clears the A1F flag in SQWINT (set it to false).
